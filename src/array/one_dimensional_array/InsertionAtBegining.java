...
// Program to insert the element at the beginning of an array
public class InsertionAtBegining {
	...
	// Printing an array after inserting an element at the beginning
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("\nArray after inserting an element at the beginning : ");
			finalArray(arr, size);
		}
		catch (Exception ex) {
